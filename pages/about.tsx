    ...
    case 0:
      elem = (
        <InfoCard
          ...
          currCard={activeCard}
          info={`As a passionate music producer, I bring creativity, technical expertise, and a passion for music to every project. With a keen ear for sound and an eye for detail, I collaborate closely with artists, songwriters, and recording engineers to shape the overall detailing and production of songs and albums. My ability to translate musical ideas into reality ensures that each recording resonates with authenticity and artistic vision.`}
        />
      );
      break;
    case 1:
      ...
      <Layout>
        ...
        >
          ...
          >
            ...
            >
              <h1 className={`text-3xl`}>My name is Shivam.</h1>
              <p className={`text-right  w-4/5`}>
              As a passionate music producer, I bring creativity, technical expertise, and a passion for music to every project. With a keen ear for sound and an eye for detail, I collaborate closely with artists, songwriters, and recording engineers to shape the overall detailing and production of songs and albums.
              </p>
            </motion.div>
            <div
            ...
            >
              <p className={`text-left`}>
                <strong className="text-4xl">M</strong>y ability to translate musical ideas into reality ensures that each recording resonates with authenticity and artistic vision.
              </p>
            </div>
          </motion.section>
        </main>
