  ...
  return (
    <div className={`w-screen h-screen`}>
      ...
      <Layout>
        ...
        <main
          className={`h-full flex flex-col lg:items-baseline items-center justify-center Particles`}
        >
          <AnimatePresence>
            <motion.section
              initial={{ opacity: 0 }}
            ...
            >
              ...
              >
                ...
                <span className={`md:text-black text-white `}>
                  {" "}
                  Shiv
                  <span className={`lg:text-white`}>am</span>
                </span>
              </h1>
              <div className={`lg:w-80 md:w-56`}>
                ...
                >
                  Passionate about creating <strong>good</strong> and{" "}
                  <strong>
                    Mind-Blowing{" "}
